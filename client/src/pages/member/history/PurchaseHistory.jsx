...
import { InputHookForm, Pagination, ReactSelect } from '../../../components';
    ...
    return (
        <div className='w-full flex flex-col gap-4 relative'>
                ...
                <tbody className='text-[14px] text-center'>
                    {orders?.orders?.map((item, index) => (
                        <tr className='border-b border-blue-200'
                                    ...
                                    <span
                                        ...
                                        <span className='flex flex-col items-start'>
                                            <span>
                                                ...
                                                <span className='border rounded-md text-[11px] bg-gray-600 text-white'>{` x${product?.quantity}`}</span>
                                            </span>
                            ...
                            <td className='font-medium'>{item?.paymentMethod}</td>
            ...
            <div className='flex justify-end'>
                <Pagination totalCount={orders?.orders?.length} />
            </div>
        </div >
    )
}
